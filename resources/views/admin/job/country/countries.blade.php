...
@section('content')
    ...
    <h4>Countries</h4>
    <p class="my-3">This is job coutry list. You can create or update or delete countries from here. </p>
    <a href="{{route('admin_job_countries')}}" class="btn btn-primary mb-3">Add New Country</a>
            ...
            <div class="card">
                @if($country == null || $country->id <= 0)
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('admin_save_country') }}"
                ...
                @else
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST"
                              action="{{ route('update_job_country', $country->id) }}" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                <div class="custom-uploder">
                                    ...
                                    <input type="file" name="imgInp" class="hdn-uploder" id="imgInp" {{$country->flag != null ? '' : 'required="required"'}}
                                           accept="image/*"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary table-btn"
                                           href="{{route('edit_job_country', $country->id)}}"><i
                                                class="mdi mdi-table-edit"></i></a>
                                        <a class="btn btn-danger table-btn"
                                           href="{{route('delete_job_country', $country->id)}}"><i
