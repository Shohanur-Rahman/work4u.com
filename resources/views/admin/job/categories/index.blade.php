...
<h4>Categories</h4>
<p class="my-3">This is job category list. You can create or update or delete category from here. </p>
<a href="{{route('admin_job_category')}}" class="btn btn-primary mb-3">Add New Category</a>
    ...
    <div class="col-md-4 col-sm-5 col-xs-12 mb-5">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form class="forms-sample" method="POST" action="{{ route('admin_save_category') }}" enctype="multipart/form-data" data-parsley-validate>
          	@csrf
        ...
        <div class="card-body">
          ...
          <form class="forms-sample" method="POST" action="{{ route('admin_update_category', $country->id) }}" enctype="multipart/form-data" data-parsley-validate>
          	@csrf
            <div class="form-group">
              <label for="txtName">Name</label>
                            ...
                            <tbody>
                                ...
                                @foreach($countries as $country )
									<tr>
	                                    ...
	                                    <td>{{$country->name}}</td>
	                                    <td>
	                                    	<a class="btn btn-primary table-btn" href="{{route('admin_edit_category', $country->id)}}"><i class="mdi mdi-table-edit"></i></a>
                                            <a class="btn btn-danger table-btn" href="{{route('admin_delete_job_category', $country->id)}}"><i class="mdi mdi-delete-forever"></i></a>
	                                    </td>
	                                </tr>
                            	@endforeach
                            </tbody>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
        ...
        if ($.trim(successMessage) != "")
          ...
          ActiveLeftSideMenuOnLoad(".job_nav ", 3);
    });
</script>
