      ...
      <div class="col-md-12 col-xs-12 col-sm-12">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-custom">
            ...
            <li class="breadcrumb-item active" aria-current="page"><span>Applications</span></li>
          </ol>
        </nav>
    </div>
</div>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->job_name->name}}</td>
                                     ...
                                     @if($item->is_approved)
                                        ...
                                        @endif
                                    <td>
                                        <a class="btn btn-primary table-btn" href="{{route('review_job_application', $item->id)}}"><i class="mdi mdi-eye"></i></a>
                                        <a class="btn btn-danger table-btn" href="{{route('deleted_job_application', $item->id)}}"><i class="mdi mdi-delete-forever"></i></a>
                                    </td>
                                </tr>
                                @endforeach
