           			 ...
           			 <table id="category-table" class="table dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Not found</td>
                                    @endif
                                    @if($item->offer && $item->offer->country)
                                    ...
                                    @endif
                                     ...
                                     @if($item->is_approved)
                                        ...
                                        @endif
                                    <td>
                                        <a class="btn btn-primary table-btn" href="{{route('edit_job_offer_comments', $item->id)}}"><i class="mdi mdi-table-edit"></i></a>
                                        <a class="btn btn-danger table-btn" href="{{route('delet_job_comment', $item->id)}}"><i class="mdi mdi-delete-forever"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
