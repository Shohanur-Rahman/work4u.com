    ...
    <div class="col-md-12 col-sm-12 col-xs-12 mb-5">
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms-sample" method="POST" action="{{ route('faqs.update', $faq->id) }}" enctype="multipart/form-data" data-parsley-validate>
            ...
            <div class="form-group">
              ...
              <input type="text" name="question" class="form-control" id="question" placeholder="Enter your question" value="{{$faq->question}}" required="required">
                </div>
            </div>
         ...
         <div class="form-group mt-5">
              ...
              <textarea id="answers" class="form-control my_editor" rows="10" cols="30" name="answers" aria-label="answers" required="required">{!! $faq->answers !!}</textarea>
            </div>
