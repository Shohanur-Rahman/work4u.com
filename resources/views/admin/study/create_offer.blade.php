      ...
      <div class="col-md-12 col-xs-12 col-sm-12">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-custom">
            ...
            <li class="breadcrumb-item active" aria-current="page"><span>New Offer</span></li>
          </ol>
        </nav>
    </div>
</div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 mb-5">
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms-sample" method="POST" action="{{ route('save_study_offer') }}" enctype="multipart/form-data" data-parsley-validate>
          	@csrf
            ...
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control" id="txtName" placeholder="Subject Name"  required="required">
            </div>
            <div class="form-group">
              <label for="txtSummary">Offer summary<span class="text-danger">*</span></label>
              <input type="text" name="summary" class="form-control" id="txtSummary" placeholder="Offer summary"  required="required">
            </div>
            ...
            <div class="form-group">
              ...
              <textarea id="financial_requirement" class="form-control my_editor" rows="10" cols="30" name="financial_requirement" aria-label="financial_requirement" required="required"></textarea>
            </div>

            <div class="form-group">
              <label for="documents_required">Documents required for Application<span class="text-danger">*</span></label>
              <textarea id="documents_required" class="form-control my_editor" rows="10" cols="30" name="documents_required" aria-label="documents_required" required="required"></textarea>
            </div>
            ...
            <div class="form-group">
              ...
              <textarea id="extra_details1" class="form-control my_editor" rows="10" cols="30" name="extra_details1" aria-label="extra_details1"></textarea>
            </div>
            ...
            <div class="form-group">
              ...
              <textarea id="extra_document2" class="form-control my_editor" rows="10" cols="30" name="extra_document2" aria-label="extra_document2"></textarea>
            </div>
            ...
            <div class="form-group">
              ...
              <textarea id="extra_document3" class="form-control my_editor" rows="10" cols="30" name="extra_document3" aria-label="extra_document3"></textarea>
            </div>
