...
@section('content')
    ...
    <h4>Countries</h4>
    <p class="my-3">This is study coutry list. You can create or update or delete countries from here. </p>
    <a href="{{route('admin_study_country')}}" class="btn btn-primary mb-3">Add New Country</a>
            ...
            <div class="card">
                @if($country == null || $country->id <= 0)
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('admin_study_save_country') }}"
                ...
                @else
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST"
                              action="{{ route('admin_study_update_country', $country->id) }}"
                              enctype="multipart/form-data" data-parsley-validate>
                            @csrf
                            <div class="form-group">
                                <label for="txtName">Name</label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary table-btn"
                                           href="{{route('admin_study_country_edit', $country->id)}}"><i
                                                class="mdi mdi-table-edit"></i></a>
                                        <a class="btn btn-danger table-btn"
                                           href="{{route('admin_study_country_delete', $country->id)}}"><i
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            ActiveLeftSideMenuOnLoad(".study_nav ", 1);
