                                ...
                                <tr>
                                    ...
                                    <td>{{$item->job_name->name}}</td>
                                     ...
                                     @if($item->is_approved)
                                        ...
                                        @endif
                                    <td>
                                        <a class="btn btn-primary table-btn" href="{{route('review_study_application', $item->id)}}"><i class="mdi mdi-eye"></i></a>
                                        <a class="btn btn-danger table-btn" href="{{route('deleted_study_application', $item->id)}}"><i class="mdi mdi-delete-forever"></i></a>
                                    </td>
                                </tr>
                                @endforeach
...
<script type="text/javascript">
	...
	$(document).ready(function () {
        ...
        ActiveLeftSideMenuOnLoad(".study_nav ", 4);
    });
</script>
