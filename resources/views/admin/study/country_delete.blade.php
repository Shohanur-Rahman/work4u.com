      ...
      <div class="col-md-12 col-xs-12 col-sm-12">
        <nav aria-label="breadcrumb">
         <ol class="breadcrumb breadcrumb-custom">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin_study_country')}}">Countries</a></li>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12 mb-5">
      <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" method="POST" action="{{ route('admin_study_country_delete_post', $data->id) }}" enctype="multipart/form-data" data-parsley-validate>
              @csrf
