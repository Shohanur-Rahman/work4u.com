    ...
    <div class="col-md-12 col-sm-12 col-xs-12 mb-5">
      <div class="card">
        <div class="card-body">
            ...
            <p class="text-danger my-3">If you delete a immigration offer you cann't recover it from server. Please confirm PIN "<strong>{{$randomText}}</strong>" to Delete. </p>
            <form class="forms-sample" method="POST" action="{{ route('delete_immigration_offer_post', $data->id) }}" enctype="multipart/form-data" data-parsley-validate>
              @csrf
