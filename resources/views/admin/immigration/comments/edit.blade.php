      ...
      <div class="col-md-12 col-xs-12 col-sm-12">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb breadcrumb-custom">
            ...
            <li class="breadcrumb-item"><a href="{{route('admin_immigration_comments')}}">Comments</a></li>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 mb-5">
      <div class="card">
        <div class="card-body">
          ...
          <form class="forms-sample" method="POST" action="{{ route('admin_update_immigration_comment',$comment->id) }}" enctype="multipart/form-data" data-parsley-validate>
          	@csrf
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ActiveLeftSideMenuOnLoad(".immigration_nav ", 4);
    });
  </script>
