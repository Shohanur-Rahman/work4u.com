        ...
        <div class="row">
            <div class="col-md-9">
                <div class="row offer-details-row">
                    ...
                    <div class="col-md-12 single_job_main">
                        <h2 class="job-details-header">IELTS Requirements</h2>
                        <div class="job-details-content">
                            {!!html_entity_decode($offer->ielts_requirment)!!}
                        </div>
                    </div> 
                
                    @if($offer->apply_instruction)
                    <div class="col-md-12 single_job_main">
                        <h2 class="job-details-header">Apply Instructions</h2>
                        <div class="job-details-content">
    ...
    <i class="fas fa-reply"></i>
                                            ...
                                            <div class="collapse" id="collapsreply">
                                              <div class="comment-box">
                                                <div class="col-md-8 col-sm-8 col-xs-10">
                                                    <form class="forms-sample" method="POST" action="{{ route('immigration_offer_comments') }}" enctype="multipart/form-data" data-parsley-validate>
                                                        @csrf
            ...
            <div class="col-md-3">
                ...
                <div class="sjs_box_action">
                    ...
                    <p>- or -</p>
                    <a class="btn btn-primary" href="{{route('user_immigration_offeres_application', ['countryname'=> $countryname,'countryid'=> $offer ->country_id,'id'=> $offer ->id])}}">Apply Study</a>
                </div>
            </div>
        </div>
    </div>
