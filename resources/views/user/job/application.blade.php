        ...
        <div class="row">
            <div class="col-md-9">
                <div class="row offer-details-row">
                    <form class="full-width-form" method="POST" action="{{ route('job_send_application') }}" enctype="multipart/form-data" data-parsley-validate>
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="Study Application for : {{$offer->name}}"
                            />
                        </div>
                        <div class="form-group">
